...
namespace Tenweb_Manager {
    ...
    class RestApi
    {
        ...
        public function update_item($request)
        {
            ...
            switch ($endpoint) {
                ...
                case 'templates':
                    ...
                    $response = $this->install_template($template_id, $template_url, $type, $action, $page_title, $post_status, $menu_term_id, $menu_item_id, $menu_item_position, $no_resize );
        ...
        public function install_template($template_id, $template_url, $type, $action, $page_title, $post_status ,$menu_term_id, $menu_item_id, $menu_item_position, $no_resize = 0)
        {
