...
class OptimizerMain
{
    ...
    public function init()
    {
        ...
        if (
          ...
          && \TenWebOptimizer\OptimizerUrl::urlIsOptimizable() //whether url is excluded from fastcgi cached pages or manually excluded
          ...
          && ( 'on' != $this->two_test_mode || isset( $_GET[ "twbooster" ] ) )
            ...
            if ( !$term_id ) {
              ...
              $page_mode = get_term_meta( $term_id, "two_mode", true );
            }
            ...
            if( $page_id === "front_page" ) {
                ...
                update_term_meta( $term_id, "two_optimized_date", $date );
            }
            else {
    ...
    private function end_buffering($content)
    {
        ...
        return $this->add_lazyload_js_footer($content);
    }
