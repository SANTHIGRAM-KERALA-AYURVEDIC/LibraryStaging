...
?>
<div class="two_settings_container" dir="ltr">
    <div class="two_settings wd-box-section">
        <div class="wd-box-title">
            <strong><?php _e(TWO_SO_ORGANIZATION_NAME . ' Booster', 'tenweb-speed-optimizer') ?></strong> <small>v<?php echo TENWEB_SO_VERSION; ?></small>
        </div>
