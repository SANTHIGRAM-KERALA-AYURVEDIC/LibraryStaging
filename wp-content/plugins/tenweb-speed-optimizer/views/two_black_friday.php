...
<p class="two_pro_option two_pro_bg_flash"><?php echo sprintf(__('Auto-optimize all %s pages and %s images', 'tenweb-speed-optimizer'), $black_friday_total_pages, $black_friday_total_images ); ?></p>
